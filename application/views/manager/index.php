<div class="container pt-5">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <br><br>
            <a class="btn btn-info w-50" style="min-height:100px !important; vertical-align:middle; padding-top:35px" href="<?=base_url()?>manager/list-belanja" role="button">Daftar Belanja</a>
            <br><br>
